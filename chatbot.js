...
class ChatBot {
    constructor() {
        ...
        this.webhookUrl = 'https://sheraiyl.app.n8n.cloud/webhook/chat_webhook';
                ...
                <div class="chatbot-panel" id="chatbotPanel">
                    ...
                    <div class="chat-messages" id="chatMessages">
                        <div class="message system">
                            Welcome to SherAIyl - your personal chatbot assistant to navigate this website.
                        </div>
                    </div>
    ...
    loadChatHistory() {
        ...
        if (recentHistory.length === 0) {
            ...
            setTimeout(() => {
                this.addMessage('Hello! I\'m AI Assistant SherAiyl. How can i help you today');
            }, 1000);
        }
    }
